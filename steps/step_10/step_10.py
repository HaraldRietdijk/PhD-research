...
from steps.step_10.step_10_save_results import save_filter_method_results
...
def do_filter_methods(app, dataframes, features, folder):
    ...
    for i in range(5):
        ...
        save_filter_method_results(app, filter_methods_scores, run_id)
...
def do_lasso(app, dataframes, features, folder):
    for i in range(5):
        ...
        lasso_scores = get_lasso_scores(dataframes, features, thresholds)
        complete_run(app, run_id)
