...
from steps.step_8.step_8_plot_ranking import plot_ranking_per_model
from steps.step_8.step_8_plot_scoring import plot_score_per_model_per_nr_features_selected, plot_score_per_model_for_optimization
...
def plot_results_optimization(app, folder):
    print('Step 8: plotting results for optimization')
    folder = folder + '/plots'
    check_folder(folder)
