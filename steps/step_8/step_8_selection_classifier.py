...
from steps.step_generic_code.general_variables.general_variables_all_rtw_1 import FITTING_PARAMETERS, CLASSIFIERS, ALGORITHM_PARAMETERS
from steps.step_8.step_8_generic_selection import save_pickle_and_metrics
      
def fit_models(X_train, Y_train):
    print("Step 8 CS: Fitting models")
    fitted_models = {}
    for name, regressor, normalized, is_max in CLASSIFIERS:
        print("Model: ", name)
